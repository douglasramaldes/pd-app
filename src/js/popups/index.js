...
import CollectionCreator from "./collection_creator";
import CollectionSelector from "./collection_selector";
import DiscoCreator from "./disco_creator";

import OptionsMenu from "./options";

const popups = {
  "Collection Creator": <CollectionCreator />,
  "Collection Selector": <CollectionSelector />,
  "Disco Creator": <DiscoCreator />,
  Options: <OptionsMenu />
};
